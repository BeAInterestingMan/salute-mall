...
public class ProductDetailInfoClientFallback implements FallbackFactory<ProductClient> {
    ...
    public ProductClient create(Throwable throwable) {
        return new ProductClient() {
            @Override
            public Result<List<ProductSkuPloyDetailResponse>> queryProductSkuDetail(@NotEmpty List<String> skuCodeList) {
            ...
            @Override
            public Result<ProductSkuPloyDetailResponse> getProductSkuDetail(@NotBlank String skuCode) {
