...
/**
 *  @Description 会员认证策略实现类
 *  @author liuhu
 *  @Date 2022/12/19 18:33
 */
@Component
@Slf4j
public class MemberAuthenticateStrategy implements AuthenticateStrategy {
    ...
    public SimpleUserInfoDTO doAuthenticate(String userCode, String systemUserType) {
        // TODO 是否需要加缓存
        SaluteAssertUtil.isTrue(Objects.equals(systemUserType, SystemUserTypeEnum.MEMBER.getValue()),"用户类型异常");
