...
@Data
@TableName("marketing_coupon_use_rule_detail")
@ApiModel(value = "营销优惠券使用规则明细表")
public class MarketingCouponUseRuleDetail implements Serializable {
    ...
    @ApiModelProperty(value = "指定分类  指定商品",name = "specificType")
    @TableField("specific_type")
    private String specificType;

    @ApiModelProperty(value = "特定编号 1-指定分类 则为分类编号",name = "specificCode")
